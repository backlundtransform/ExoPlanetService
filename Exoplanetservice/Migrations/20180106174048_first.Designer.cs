...
namespace Exoplanetservice.Migrations
{
    ...
    [Migration("20180106174048_first")]
    partial class first
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ExoplanetService.Models.Constellation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("ExoplanetService.Models.Planet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("ExoplanetService.Models.Star", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("ExoplanetService.Models.Planet", b =>
                {
                    b.HasOne("ExoplanetService.Models.Star", "Star")
                        .WithMany("Planets")
            ...
            modelBuilder.Entity("ExoplanetService.Models.Star", b =>
                {
                    b.HasOne("ExoplanetService.Models.Constellation", "Constellation")
                        .WithMany()
