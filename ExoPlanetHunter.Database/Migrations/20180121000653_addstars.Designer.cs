...
namespace ExoPlanetHunter.Database.Migrations
{
    ...
    [Migration("20180121000653_addstars")]
    partial class addstars
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ExoPlanetHunter.Pocos.Constellation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("ExoPlanetHunter.Pocos.Planet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("ExoPlanetHunter.Pocos.Star", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("ExoPlanetHunter.Pocos.Planet", b =>
                {
                    b.HasOne("ExoPlanetHunter.Pocos.Star", "Star")
                        .WithMany("Planets")
            ...
            modelBuilder.Entity("ExoPlanetHunter.Pocos.Star", b =>
                {
                    b.HasOne("ExoPlanetHunter.Pocos.Constellation", "Constellation")
                        .WithMany("Stars")
